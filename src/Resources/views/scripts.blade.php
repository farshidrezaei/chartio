...
*/
    'use strict';
    (function (c) {
        "object" === typeof module && module.exports ? (c["default"] = c, module.exports = c) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function (q) {
            c(q);
            c.Highcharts = q;
            return c
        ...
        c = c ? c._modules : {};
        q(c, "Extensions/FullScreen.js", [c["Core/Chart/Chart.js"], c["Core/Globals.js"], c["Core/Renderer/HTML/AST.js"], c["Core/Utilities.js"]],
            function (c, m, h, k) {
                var n = k.addEvent;
                k = function () {
                    function c(e) {
                    ...
                    c.prototype.close = function () {
                        var e = this.chart, c = e.options.chart;
                    ...
                    c.prototype.open = function () {
                        var e = this, c = e.chart, h = c.options.chart;
                    ...
                    c.prototype.setButtonText = function () {
                        var e = this.chart, c = e.exportDivElements, k = e.options.exporting,
                            m = k && k.buttons && k.buttons.contextButton.menuItems;
                        e = e.options.lang;
                        k && k.menuItemDefinitions && e && e.exitFullscreen &&
        ...
        q(c, "Extensions/Exporting.js", [c["Core/Chart/Chart.js"], c["Mixins/Navigation.js"], c["Core/Globals.js"], c["Core/DefaultOptions.js"], c["Core/Color/Palette.js"], c["Core/Renderer/SVG/SVGRenderer.js"], c["Core/Utilities.js"]], function (c, m, h, k, n, q, e) {
            var z = h.doc, H = h.isTouchDevice, B = h.win;
            k = k.defaultOptions;
            var D = q.prototype.symbols, x = e.addEvent, r = e.css, y = e.createElement, F = e.discardElement,
                A = e.extend, I = e.find, E = e.fireEvent, J = e.isObject, p = e.merge, G = e.objectEach, t = e.pick,
                K = e.removeEvent, L = e.uniqueKey;
            A(k.lang, {
            ...
            p(!0, k.navigation, {
                buttonOptions: {
                    theme: {}, symbolSize: 14, symbolX: 12.5,
                    symbolY: 10.5, align: "right", buttonSpacing: 3, height: 22, verticalAlign: "top", width: 24
                }
            });
            p(!0, k.navigation, {
                menuStyle: {border: "1px solid " + n.neutralColor40, background: n.backgroundColor, padding: "5px 0"},
                menuItemStyle: {
                    padding: "0.5em 1em",
                ...
                menuItemHoverStyle: {background: n.highlightColor80, color: n.backgroundColor},
                buttonOptions: {
            ...
            h.post = function (a, b, f) {
                var d = y("form", p({method: "post", action: a, enctype: "multipart/form-data"},
                    f), {display: "none"}, z.body);
                G(b, function (a, b) {
            ...
            A(c.prototype, {
                sanitizeSVG: function (a, b) {
                    ...
                    a = a.substr(0, f);
                    b && b.exporting && b.exporting.allowHTML && d && (d = '<foreignObject x="0" y="0" width="' + b.chart.width + '" height="' + b.chart.height + '"><body xmlns="http://www.w3.org/1999/xhtml">' +
                        d.replace(/(<(?:img|br).*?(?=>))>/g, "$1 />") + "</body></foreignObject>", a = a.replace("</svg>", d + "</svg>"));
                    ...
                    u = f.exporting.sourceHeight || f.chart.height || /px$/.test(u) && parseInt(u, 10) || 400;
                    A(f.chart, {
                        animation: !1,
                        renderTo: d,
                        forExport: !0,
                    ...
                    this.axes.forEach(function (a) {
                        ...
                        a.options.isInternal || (h[a.coll] || (h[a.coll] = !0, f[a.coll] = []), f[a.coll].push(p(a.userOptions, {visible: a.visible})))
                    });
                    ...
                    return this.getSVG(p({chart: {borderRadius: 0}}, f.chartOptions, b, {
                        exporting: {
                    ...
                    var a = this.userOptions.title &&
                        this.userOptions.title.text, b = this.options.exporting.filename;
                    ...
                    var a = z.body, b = this.options.exporting.printMaxWidth,
                    ...
                    var g = this, u = g.options.navigation, m = g.chartWidth, C = g.chartHeight, v = "cache-" + a,
                        l = g[v], w = Math.max(c, h);
                    if (!l) {
                        g.exportContextMenu = g[v] = l = y("div", {className: a}, {
                            position: "absolute",
                            zIndex: 1E3,
                            padding: w + "px",
                            pointerEvents: "auto"
                            ...
                            g.container);
                        var p = y("ul", {className: "highcharts-menu"}, {listStyle: "none", margin: 0, padding: 0}, l);
                        g.styledMode || r(p, A({
                        ...
                        l.hideMenu = function () {
                            ...
                            E(g, "exportMenuHidden")
                        };
                        g.exportEvents.push(x(l, "mouseleave", function () {
                        ...
                        b.forEach(function (a) {
                            ...
                            if (J(a, !0)) {
                                var b = void 0;
                                a.separator ? b = y("hr", null, null, p) : ("viewData" === a.textKey && g.isDataTableVisible && (a.textKey = "hideData"), b = y("li", {
                                    className: "highcharts-menu-item", onclick: function (b) {
                                        b && b.stopPropagation();
                                        l.hideMenu();
                                        a.onclick && a.onclick.apply(g, arguments)
                                    }
                                }, null, p), b.appendChild(z.createTextNode(a.text || g.options.lang[a.textKey])), g.styledMode || (b.onmouseover = function () {
                    ...
                    b = {display: "block"};
                    f + g.exportMenuWidth > m ? b.right = m - f - c - w + "px" : b.left = f - w + "px";
                    d + h + g.exportMenuHeight >
                    C && "top" !== k.alignOptions.verticalAlign ? b.bottom = C - d - w + "px" : b.top = d + h - w + "px";
                    r(l, b);
                    ...
                    var b = this, f = b.renderer, d = p(b.options.navigation.buttonOptions, a), c = d.onclick,
                        e = d.menuItems, h = d.symbolSize || 12;
                    b.btnCount || (b.btnCount = 0);
                    b.exportDivElements || (b.exportDivElements = [], b.exportSVGElements = []);
                    if (!1 !== d.enabled && d.theme) {
                        var g = d.theme, k = g.states, m = k && k.hover;
                        k = k && k.select;
                        var C;
                        b.styledMode ||
                        (g.fill = t(g.fill, n.backgroundColor), g.stroke = t(g.stroke, "none"));
                        delete g.states;
                        c ? C = function (a) {
                            a && a.stopPropagation();
                            c.call(b, a)
                            ...
                            a && a.stopPropagation();
                            b.contextMenu(v.menuClassName, e, v.translateX, v.translateY, v.width, v.height, v);
                            v.setState(2)
                        });
                        d.text && d.symbol ? g.paddingLeft = t(g.paddingLeft, 30) : d.text || A(g, {
                            width: d.width,
                            height: d.height,
                            padding: 0
                        });
                        b.styledMode || (g["stroke-linecap"] = "round", g.fill = t(g.fill, n.backgroundColor), g.stroke = t(g.stroke, "none"));
                        var v = f.button(d.text,
                            0, 0, C, g, m, k).addClass(a.className).attr({title: t(b.options.lang[d._titleKey || d.titleKey], "")});
                        v.menuClassName = a.menuClassName || "highcharts-menu-" + b.btnCount++;
                        if (d.symbol) {
                            var l = f.symbol(d.symbol, d.symbolX - h / 2, d.symbolY - h / 2, h, h, {
                                width: h,
                                height: h
                            }).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(v);
                            b.styledMode || l.attr({
                        ...
                        v.add(b.exportingGroup).align(A(d, {
                            width: v.width,
                            x: t(d.x, b.buttonOffset)
                        }), !0, "spacingBox");
                        b.buttonOffset += (v.width + d.buttonSpacing) * ("right" === d.align ? -1 : 1);
                        b.exportSVGElements.push(v, l)
                    }
                }, destroyExport: function (a) {
                    var b = a ? a.target : this;
                    a = b.exportSVGElements;
                    var f = b.exportDivElements, d = b.exportEvents, c;
                ...
                function () {
                    ...
                    function b(c) {
                        function f(b, f) {
                            ...
                            for (t = e.length; t-- && !w;) w = e[t].test(f) || "function" === typeof b;
                            w || z[f] === b && "svg" !== c.nodeName || g[c.nodeName][f] === b || (d && -1 === d.indexOf(f) ? l += a(f) + ":" + b + ";" : b && c.setAttribute(a(f), b))
                        }
                        ...
                        if (1 === c.nodeType && -1 === m.indexOf(c.nodeName)) {
                            ...
                            var z =
                                "svg" === c.nodeName ? {} : B.getComputedStyle(c.parentNode, null);
                            if (!g[c.nodeName]) {
                            ...
                            if (h.isFirefox || h.isMS) for (var y in u) f(u[y], y); else G(u, f);
                            l && (u = c.getAttribute("style"), c.setAttribute("style", (u ? u + ";" : "") + l));
                            "svg" === c.nodeName && c.setAttribute("stroke-width", "1px");
                            "text" !== c.nodeName && [].forEach.call(c.children ||
                                c.childNodes, b)
                        }
                    }

                    var c = this.renderer, d = c.inlineToAttributes, e = c.inlineBlacklist, k = c.inlineWhitelist,
                        m = c.unstyledElements, g = {}, n;
            ...
            D.menu = function (a, b, c, d) {
                return [["M", a, b + 2.5], ["L", a + c, b + 2.5], ["M",
                    a, b + d / 2 + .5], ["L", a + c, b + d / 2 + .5], ["M", a, b + d - 1.5], ["L", a + c, b + d - 1.5]]
            };
            D.menuball = function (a, b, c, d) {
                a = [];
                d = d / 3 - 2;
                return a = a.concat(D.circle(c - d, b, d, d), D.circle(c - d, b + d + 4, d, d), D.circle(c - d, b + 2 * (d + 4), d, d))
            };
